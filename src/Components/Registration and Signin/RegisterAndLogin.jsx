...
import { FaEye, FaEyeSlash } from "react-icons/fa"; import axios from "../../AxiosConfigration/axiosConfig";
              ...
              <div className="textCenter">
                <Link to="/home" className="white">
                  <button className="button" onClick={agreeAndJoinHandler}>
                    {isLoadingSignup ? "Registering ..." : "Agree and Join"}
                  </button>
                </Link>
              ...
              <div className="textCenter">
                <Link to="/home" className="white">
                  <button className="button" onClick={loginHandler}>
                    {isLoadingLogin ? "Signing ..." : "Sign in"}
                  </button>
                </Link>
              </div>
